    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='product/img', verbose_name='Imagen Principal')),
                ('destacado', models.BooleanField(default=False, verbose_name='Destacada')),
                ('color', models.CharField(choices=[('198754', 'Verde'), ('ffc107', 'Amarillo'), ('8cbf44', 'Verde Claro'), ('fd7e14', 'Anaranjado'), ('dc3545', 'Rojo'), ('6c757d', 'Gris'), ('0d6efd', 'Azul')], default='198754', max_length=100, verbose_name='Color')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono_receptor', models.CharField(max_length=200, verbose_name='Teléfono del receptor')),
                ...
                ('reparto', models.CharField(blank=True, max_length=200, null=True, verbose_name='Reparto')),
